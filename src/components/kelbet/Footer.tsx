...
export function Footer() {
  return (
    <footer className="relative z-10 rounded-t-[3rem] bg-card/70 px-6 py-16 text-center backdrop-blur-sm">
      ...
      <p className="mt-2 text-[0.65rem] uppercase tracking-[0.4em] text-muted-foreground">Korean cosmetics</p>
      ...
      <p className="mt-6 text-xs text-muted-foreground">© 2026 KELBET. Все права защищены.</p>
    </footer>
  );
}
